...
insert into employees (id, last_name, first_name, email, phone, address1, address2, city, state, postal_code, country, avatar, job_title, department, manager_id) values
 (201, 'Harris'  , 'George' , 'gharris0@pagesperso-orange.fr', '1-(210)270-8536', '2 Bayside Drive', null, 'San Antonio', 'Texas', '78240', 'United States', 'https://robohash.org/modilaboriosammolestiae.bmp?size=50x50&set=set1', 'Administrative Assistant I', 'divers', null)
...
,(203, 'Palmer'  , 'Anthony', 'apalmer2@posterous.com', '1-(702)984-2108', '02809 4th Pass', null, 'North Las Vegas', 'Nevada', '89036', 'United States', 'https://robohash.org/vitaererumdolore.png?size=50x50&set=set1', 'Health Coach II', 'divers', null)
...
insert into products (id, product_code, product_name, description, standard_cost, list_price, target_level, reorder_level, minimum_reorder_quantity, quantity_per_unit, discontinued, category) values
 (601, 'P1' , 'compte courant'            , null, 1167.09, 1123.39, 75 , 10, 10, 50, 1, 'quotidien')
,(602, 'P2' , 'cartes bancaires professionnelles'  , null, 1382.83, 1293.84, 90 , 15, 15, 56, 0, 'quotidien')
,(603, 'P3' , 'services de banque a distance '     , null, 1482.83, 1393.84, 95 , 20, 30, 56, 0, 'quotidien')
,(604, 'P4' , 'operations de virements'            , null, 382.83 , 293.84 , 180, 75, 50, 56, 0, 'quotidien')
,(605, 'P5' , 'factoring'                          , null, 882.83 , 793.84 , 40 , 15, 15, 56, 0, 'quotidien')
,(606, 'P6' , 'gestion des flux financiers'        , null, 633.88 , 511.7  , 75 , 10, 20, 79, 1, 'quotidien' )
,(607, 'P7' , 'credits (pret d’investissement)'    , null, 1441.02, 1308.98, 100, 30, 10, 92, 1, 'financement')
,(608, 'P8' , 'avance a vue et a terme'            , null, 538.44 , 462.34 , 75 , 20, 20, 54,  1, 'financement' )
,(609, 'P9' , 'prets d equipement SNCI'            , null, 547.58 , 481.83 , 50 , 5 , 15, 58, 1, 'financement')
,(610, 'P10', 'leasing financier et operationnel'  , null, 1625.81, 1576.61, 120, 40, 30, 11, 1, 'financement')
,(611, 'P11', 'factoring'                          , null, 867.09 , 723.39 , 75 , 25, 15, 50, 1, 'financement')
,(612, 'P12', 'Global Trade Services et Escrow Service'  , null, 882.83 , 793.84 , 50 , 10, 5 , 56, 0, 'financement')
,(613, 'P13', 'Compte Epargne Entreprise'          , null, 1182.83, 1093.84, 55 , 10, 5 , 56, 0, 'placement')
,(614, 'P14', 'depot a court terme'                , null, 1382.83, 1293.84, 50 , 10, 10, 56, 0, 'placement')
,(615, 'P15', 'placement des excedents de tresorerie' , null, 1682.83, 1593.84, 200, 80, 50, 56, 0, 'placement')
,(616, 'P16', 'Epargne etudiant'                   , null, 833.88 , 711.76 , 250, 100,50, 79, 1, 'placement' )
,(617, 'P17', 'Allure libre'                       , null, 641.02 , 608.98 , 100, 30 ,20, 92, 1, 'placement' )
,(618, 'P18', 'livret A'                           , null, 538.44 , 562.34 , 75 , 15, 10, 54,  1, 'quotidien' )
,(619, 'P19', 'Livret A sup'                       , null, 547.58 , 481.83 , 75 , 15, 15, 58, 1, 'quotidien')
,(620, 'P20', 'Mensualisation '                    , null, 1078.81, 1008.61, 80 , 14, 10, 11, 1, 'quotidien');
